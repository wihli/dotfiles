...
- Do not edit generated install outputs directly: `~/.config/AGENTS.md`, `~/.config/AGENTS.private.md`, `~/.claude/CLAUDE.md`, `~/.claude/settings.json`, `~/.claude/skills/`, `~/.claude/agents/`, `~/.agents/skills/`, `~/.codex/AGENTS.md`, `~/.codex/skills/`
