...
- Public source: `$SRC_DIR/wihli-dotfiles/agents/.config/AGENTS.md` (this file)
- Private source: `$SRC_DIR/wihli-dotfiles-private/agents/.config/AGENTS.private.md` (concatenated onto the end of this file at install time)
