...
- **Jira tickets**: `https://<instance>.atlassian.net/browse/TICKET-1234`
...
```
1. **Oct 30**: Engineer discovers cross-partition role assumption doesn't work.
   ([Slack](https://slack.com/archives/<channel>/<message>))
2. **Jan 8**: PR merges, breaks prod. Forward-fixed via [PR #1234](https://github.com/<org>/<repo>/pull/1234).
   ([#alerts-channel](https://slack.com/archives/<channel>/<message>))
```
